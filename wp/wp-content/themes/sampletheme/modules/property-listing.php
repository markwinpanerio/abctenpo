<div class="property-listing l-container">
  ...
  <section class="property-listing-section">
    <article class="property-listing-article">
      ...
      <div class="property-listing-recommendation">
        <div class="property-listing-logo">
          <img src="<?php echo resolve_asset_uri('images/property-listing-logo.png'); ?>" alt="">
        </div>
        <div class="property-listing-recommended">
          <p class="property-listing-copy">ABC店舗からのおすすめポイントを紹介します！</p>
          <ul class="property-listing-list">
            <li class="property-listing-item">新築物件を建設中！小伝馬町駅から駅徒歩６分！</li>
            <li class="property-listing-item">オフィス街でランチの需要が高いエリアです！テキストがはいります...</li>
            <li class="property-listing-item">最終募集！残り時間わずか！！テキストがはいります。</li>
          </ul>
        </div>
      </div>
    </article>
