    ...
    <div class="page-preview-group">
      <a href="<?php echo $preview_item['preview_link']; ?>" class="page-preview-link">
        ...
        <div class="page-preview-contents page-preview-box">
          <?php
            importTemplate( 'modules/tokyo/links-icon', array('link' => $preview_item['links']['text'], 'icon_modifier' => $preview_item['links']['icon_modifier'], 'text_modifier' => $preview_item['links']['text_modifier']) ); ?>
